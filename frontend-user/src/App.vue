  ...
  <div class="app">
    ...
    <aside class="sidebar" :class="{ open: sidebarOpen }">
      ...
      <nav class="nav">
        ...
        <div class="nav-group">
          <div class="nav-group-title">基础组件</div>
          <router-link
            to="/button"
            class="nav-item"
            @click="sidebarOpen = false"
          ...
          <router-link to="/tag" class="nav-item" @click="sidebarOpen = false">
...
.sidebar {
  width: 280px;
  background: #fff;
  border-right: 1px solid var(--sim-border-color);
  position: fixed;
  top: 0;
  left: 0;
  bottom: 0;
